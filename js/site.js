(function () {
  const dict = {
    en: {
      ...
      workLede: "Start simple. More advanced when the ear is ready. Hear tones, hear chords, hear melody. The floor remembers what you cleared.",
      work1t: "Hear tones",
    ...
    sv: {
      ...
      workLede: "Börja enkelt. Svårare när örat är redo. Höra toner, höra ackord, höra melodier. Golvet minns vad du städat.",
      work1t: "Höra toner",
    ...
    de: {
      ...
      workLede: "Fang einfach an. Schwerer, wenn das Ohr bereit ist. Töne hören, Akkorde hören, Melodien hören. Der Floor erinnert sich, was du geschafft hast.",
      work1t: "Töne hören",
    ...
    es: {
      ...
      workLede: "Empieza simple. Más difícil cuando el oído esté listo. Oír tonos, oír acordes, oír melodías. El piso recuerda lo que has cerrado.",
      work1t: "Oír tonos",
    ...
    fr: {
      ...
      workLede: "Commence simple. Plus dur quand l’oreille est prête. Entendre les notes, entendre les accords, entendre les mélodies. L’étage se souvient de ce que tu as fini.",

(function () {
  const dict = {
    en: {
      ...
      workLede: "Hear tones, hear chords, hear melody. You listen, then you tap. That's the gym.",
      work1t: "Hear tones",
    ...
    sv: {
      ...
      workLede: "Höra toner, höra ackord, höra melodier. Du lyssnar, sen trycker du. Det är gymmet.",
      work1t: "Höra toner",
    ...
    de: {
      ...
      workLede: "Töne hören, Akkorde hören, Melodien hören. Du hörst zu, dann tippst du. Das ist das Gym.",
      work1t: "Töne hören",
    ...
    es: {
      ...
      workLede: "Oír tonos, oír acordes, oír melodías. Escuchas, luego pulsas. Ese es el gym.",
      work1t: "Oír tonos",
    ...
    fr: {
      ...
      workLede: "Entendre les notes, entendre les accords, entendre les mélodies. Tu écoutes, puis tu tapes. C’est le gym.",

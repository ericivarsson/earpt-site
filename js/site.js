(function () {
  const dict = {
    en: {
      ...
      heroLede: "EarPT is a daily ear training app for musicians that meets you where you are: beginner to pro, simple intervals to advanced harmony. You hear an interval, a chord, or a short melody, then you name it. The sound is a sampled grand piano or an acoustic guitar.",
      heroArtCredit: "AI-generated image.",
      phoneArtCredit: "AI-generated image. The app on the bench.",
      heroBy: "A trained ear is musical freedom.",
      ctaSupport: "Support & feedback",
      ctaWhy: "See how it works",
      ...
      card3p: "A grand piano and a mic'd acoustic guitar. Organic color, so the ear trains on wood and wire — not a square wave.",
      soundKicker: "The sound",
      soundTitle: "Organic notes. Real instruments.",
      soundLede: "Ear training is only as good as what you hear. EarPT plays a sampled grand and a microphone-recorded acoustic guitar — the color of wood and string, not a toy synth.",
      sound1t: "Grand piano",
      sound1p: "Sampled keys, one voice per note. Warm enough to live with for five minutes a day.",
      sound2t: "Acoustic guitar",
      sound2p: "A mic'd acoustic guitar. Switch in Settings when you want the room to sound like strings.",
      metaDescription: "Daily ear training app for iPhone and iPad. Sampled piano and guitar. Intervals, chords, melody — five minutes, most days.",
      ...
      quote: "Built by musicians for musicians.",
      footLegal: "Privacy",
      footTerms: "Terms",
      footSupport: "Support",
      ...
      faq3a: "A sampled grand piano and a mic'd acoustic guitar. Organic color — wood and string, not a toy synth. Switch in Settings.",
      faq4q: "Is it on iPhone and iPad?",
      faq4a: "Yes. iPhone and iPad. Download it on the App Store.",
      faq5q: "Is it a subscription?",
      faq5a: "No. Ten workouts are free. Then a one-time unlock. Not a subscription.",
      workKicker: "The work",
      workTitle: "Hear it. Name it.",
      workLede: "Start simple. More advanced when the ear is ready. Hear tones, hear chords. The floor and the map remember what you cleared.",
      work1t: "Hear tones",
      work1p: "Intervals in key. The distance gets a name. Fast when you're clean.",
      work2t: "Hear chords",
      work2p: "Quality and color. Major, minor, sevenths. Spell the color, then take it on the instrument.",
      work3t: "Hear melody",
      work3p: "A phrase on the staff. What you hear inside is a line you can play.",
      workSimple: "Start simple",
      workReady: "More advanced when you're ready",
      workStafft: "Place the phrase",
      workStaffp: "Hear a line. Put it on the staff. That's the melody, not a quiz.",
      workProgt: "Your floor",
      workProgp: "Sessions you've cleared. Hits in gold. The graph is showing up.",
      workMapt: "The map",
      workMapp: "Floors and rooms. Green is cleared. Gold is here.",
      faq6q: "How do you train to hear chords?",
      faq6a: "Listen to a voicing, name the quality, do it again tomorrow. EarPT keeps you in the room until it's clean — major, minor, sevenths, then more color.",
      faq7q: "How do you train to hear melody?",
      faq7a: "A short phrase. You hear it, then you place it. Five minutes, most days. The line sticks because you come back.",
      faq8q: "How do you train to hear tones and intervals?",
      faq8a: "Two notes, in key. You name the distance. Simple when that's the job. Wider and faster when the ear is ready.",
    ...
    sv: {
      ...
      heroLede: "EarPT är en gehörsapp för musiker som möter dig där du är: nybörjare till proffs, enkla intervall till avancerad harmonik. Du hör ett intervall, ett ackord eller en kort melodi, och sätter namn på det. Ljudet är sampled flygel eller akustisk gitarr.",
      heroArtCredit: "AI-genererad bild.",
      phoneArtCredit: "AI-genererad bild. Appen på pallen.",
      heroBy: "Ett tränat öra är musikalisk frihet.",
      ctaSupport: "Support och feedback",
      ctaWhy: "Så funkar det",
      ...
      card3p: "Flygel och en mikrofoninspelad akustisk gitarr. Organisk klang, så örat tränar på trä och sträng — inte en fyrkantsvåg.",
      soundKicker: "Ljudet",
      soundTitle: "Organiska toner. Riktiga instrument.",
      soundLede: "Gehör är bara så bra som det du hör. EarPT spelar sampled flygel och en mikrofoninspelad akustisk gitarr — färgen av trä och sträng, inte en leksakssynth.",
      sound1t: "Flygel",
      sound1p: "Samplade tangenter, en röst per ton. Varm nog att leva med fem minuter om dagen.",
      sound2t: "Akustisk gitarr",
      sound2p: "En mikrofoninspelad akustisk gitarr. Byt i inställningarna när rummet ska låta som strängar.",
      metaDescription: "Gehörsträningsapp för iPhone och iPad. Sampled flygel och gitarr. Intervall, ackord, melodi — fem minuter, de flesta dagar.",
      ...
      quote: "Byggt av musiker för musiker.",
      ...
      faq3a: "Sampled flygel och en mikrofoninspelad akustisk gitarr. Organisk klang — trä och sträng, inte en leksakssynth. Byt i inställningarna.",
      faq4q: "Finns den till iPhone och iPad?",
      faq4a: "Ja. iPhone och iPad. Ladda ner i App Store.",
      faq5q: "Är det en prenumeration?",
      faq5a: "Nej. Tio pass är fria. Sen ett engångsköp som låser upp resten. Inte ett abonnemang.",
      workKicker: "Jobbet",
      workTitle: "Hör det. Säg vad det är.",
      workLede: "Börja enkelt. Svårare när örat är redo. Höra toner, höra ackord. Golvet och kartan minns vad du städat.",
      work1t: "Höra toner",
      work1p: "Intervall i tonart. Avståndet får ett namn. Snabbt när du är ren.",
      work2t: "Höra ackord",
      work2p: "Kvalitet och färg. Dur, moll, septim. Säg färgen, sen ta den på instrumentet.",
      work3t: "Höra melodier",
      work3p: "En fras på notsystemet. Det du hör inuti är en linje du kan spela.",
      workSimple: "Börja enkelt",
      workReady: "Svårare när örat är redo",
      workStafft: "Placera frasen",
      workStaffp: "Hör en linje. Sätt den på notsystemet. Det är melodin, inte ett quiz.",
      workProgt: "Ditt golv",
      workProgp: "Pass du klarat. Träffar i guld. Grafen är att du kommer tillbaka.",
      workMapt: "Kartan",
      workMapp: "Golv och rum. Grönt är klart. Guld är här.",
      faq6q: "Hur tränar man på att höra ackord?",
      faq6a: "Lyssna på en klang, säg kvaliteten, kom tillbaka i morgon. EarPT håller dig i rummet tills det är rent — dur, moll, septim, sen mer färg.",
      faq7q: "Hur tränar man på att höra melodier?",
      faq7a: "En kort fras. Du hör den, sen sätter du den. Fem minuter, de flesta dagar. Linjen fastnar för att du kommer tillbaka.",
      faq8q: "Hur tränar man på att höra toner och intervall?",
      faq8a: "Två toner, i tonart. Du namnger avståndet. Enkelt när det är jobbet. Större och snabbare när örat är redo.",
    ...
    de: {
      ...
      heroLede: "EarPT ist eine Gehörbildungs-App für Musiker, die dich abholt: Anfänger bis Profi, einfache Intervalle bis fortgeschrittene Harmonie. Du hörst ein Intervall, einen Akkord oder eine kurze Melodie und benennst es. Der Klang ist ein sampled Flügel oder eine Akustikgitarre.",
      heroArtCredit: "KI-generiertes Bild.",
      phoneArtCredit: "KI-generiertes Bild. Die App auf der Bank.",
      heroBy: "Ein trainiertes Ohr ist musikalische Freiheit.",
      ctaSupport: "Support & Feedback",
      ctaWhy: "So funktioniert’s",
      ...
      card3p: "Ein Flügel und eine mikrofonierte Akustikgitarre. Organischer Klang, damit das Ohr an Holz und Saite trainiert — nicht an einer Rechteckwelle.",
      soundKicker: "Der Klang",
      soundTitle: "Organische Töne. Echte Instrumente.",
      soundLede: "Gehörbildung ist nur so gut wie das, was du hörst. EarPT spielt einen gesampelten Flügel und eine mikrofonierte Akustikgitarre — die Farbe von Holz und Saite, kein Spielzeugsynth.",
      sound1t: "Flügel",
      sound1p: "Gesampelte Tasten, eine Stimme pro Ton. Warm genug für fünf Minuten am Tag.",
      sound2t: "Akustikgitarre",
      sound2p: "Eine mikrofonierte Akustikgitarre. Wechsle in den Einstellungen, wenn der Raum nach Saiten klingen soll.",
      metaDescription: "Gehörbildungs-App für iPhone und iPad. Sampled Flügel und Gitarre — organischer Klang, damit das Ohr an dem trainiert, was du wirklich spielst.",
      ...
      quote: "Von Musikern für Musiker.",
      ...
      faq3a: "Ein gesampelter Flügel und eine mikrofonierte Akustikgitarre. Organischer Klang — Holz und Saite, kein Spielzeugsynth. Wechsel in den Einstellungen.",
      faq4q: "Gibt’s die fürs iPhone und iPad?",
      faq4a: "Ja. iPhone und iPad. Laden im App Store.",
      ...
      workKicker: "Die Arbeit",
      workTitle: "Hör es. Benenne es.",
      workLede: "Fang einfach an. Schwerer, wenn das Ohr bereit ist. Töne hören, Akkorde hören. Der Floor und die Karte erinnern sich, was du geschafft hast.",
      work1t: "Töne hören",
      work1p: "Intervalle in der Tonart. Der Abstand bekommt einen Namen. Schnell, wenn du sauber bist.",
      work2t: "Akkorde hören",
      work2p: "Qualität und Farbe. Dur, Moll, Septimen. Benenne die Farbe, dann nimm sie aufs Instrument.",
      work3t: "Melodien hören",
      work3p: "Eine Phrase auf dem Notensystem. Was du innen hörst, ist eine Linie, die du spielen kannst.",
      workSimple: "Fang einfach an",
      workReady: "Schwerer, wenn das Ohr bereit ist",
      workStafft: "Setze die Phrase",
      workStaffp: "Hör eine Linie. Setz sie aufs Notensystem. Das ist die Melodie, kein Quiz.",
      workProgt: "Dein Floor",
      workProgp: "Sessions, die du geschafft hast. Treffer in Gold. Die Grafik ist, dass du wiederkommst.",
      workMapt: "Die Karte",
      workMapp: "Floors und Räume. Grün ist geschafft. Gold ist hier.",
      faq6q: "Wie trainiert man, Akkorde zu hören?",
      faq6a: "Hör dir eine Lage an, benenne die Qualität, mach es morgen wieder. EarPT hält dich im Raum, bis es sauber ist — Dur, Moll, Septimen, dann mehr Farbe.",
      faq7q: "Wie trainiert man, Melodien zu hören?",
      faq7a: "Eine kurze Phrase. Du hörst sie, dann setzt du sie. Fünf Minuten, die meisten Tage. Die Linie sitzt, weil du wiederkommst.",
      faq8q: "Wie trainiert man, Töne und Intervalle zu hören?",
      faq8a: "Zwei Töne, in der Tonart. Du benennst den Abstand. Einfach, wenn das die Aufgabe ist. Weiter und schneller, wenn das Ohr soweit ist.",
    ...
    es: {
      ...
      heroLede: "EarPT es una app diaria de oído para músicos que te encuentra donde estás: de principiante a pro, de intervalos simples a armonía avanzada. Oyes un intervalo, un acorde o una melodía corta, y le pones nombre. El sonido es un piano de cola sampleado o una guitarra acústica.",
      heroArtCredit: "Imagen generada con IA.",
      phoneArtCredit: "Imagen generada con IA. La app en el banco.",
      heroBy: "Un oído entrenado es libertad musical.",
      ctaSupport: "Soporte y feedback",
      ctaWhy: "Cómo funciona",
      ...
      card3p: "Un piano de cola y una guitarra acústica con micrófono. Color orgánico, para que el oído entrene con madera y cuerda — no con una onda cuadrada.",
      soundKicker: "El sonido",
      soundTitle: "Notas orgánicas. Instrumentos reales.",
      soundLede: "El oído solo es tan bueno como lo que escuchas. EarPT toca un piano de cola sampleado y una guitarra acústica grabada con micrófono — el color de la madera y la cuerda, no un sinte de juguete.",
      ...
      sound2p: "Una guitarra acústica con micrófono. Cambia en Ajustes cuando la sala deba sonar a cuerdas.",
      metaDescription: "App de entrenamiento auditivo para iPhone y iPad. Piano y guitarra sampleados. Color orgánico, para que el oído entrene con lo que realmente tocas.",
      ...
      quote: "Hecho por músicos para músicos.",
      ...
      faq3a: "Un piano de cola sampleado y una guitarra acústica con micrófono. Color orgánico — madera y cuerda, no un sinte de juguete. Cambia en Ajustes.",
      faq4q: "¿Está en iPhone y iPad?",
      faq4a: "Sí. iPhone y iPad. Descárgala en el App Store.",
      ...
      workKicker: "El trabajo",
      workTitle: "Óyelo. Ponle nombre.",
      workLede: "Empieza simple. Más difícil cuando el oído esté listo. Oír tonos, oír acordes. El piso y el mapa recuerdan lo que has cerrado.",
      work1t: "Oír tonos",
      work1p: "Intervalos en tonalidad. La distancia recibe un nombre. Rápido cuando estás limpio.",
      work2t: "Oír acordes",
      work2p: "Calidad y color. Mayor, menor, séptimas. Nombra el color, luego llévalo al instrumento.",
      work3t: "Oír melodías",
      work3p: "Una frase en el pentagrama. Lo que oyes dentro es una línea que puedes tocar.",
      workSimple: "Empieza simple",
      workReady: "Más difícil cuando el oído esté listo",
      workStafft: "Coloca la frase",
      workStaffp: "Oye una línea. Ponla en el pentagrama. Eso es la melodía, no un quiz.",
      workProgt: "Tu piso",
      workProgp: "Sesiones que has cerrado. Aciertos en oro. La gráfica es volver.",
      workMapt: "El mapa",
      workMapp: "Pisos y salas. Verde es cerrado. Oro es aquí.",
      faq6q: "¿Cómo se entrena para oír acordes?",
      faq6a: "Escucha un voicing, nombra la calidad, vuelve mañana. EarPT te deja en la sala hasta que quede limpio — mayor, menor, séptimas, luego más color.",
      faq7q: "¿Cómo se entrena para oír melodías?",
      faq7a: "Una frase corta. La oyes, luego la colocas. Cinco minutos, la mayoría de los días. La línea se queda porque vuelves.",
      faq8q: "¿Cómo se entrena para oír tonos e intervalos?",
      faq8a: "Dos notas, en tonalidad. Nombras la distancia. Simple cuando ese es el trabajo. Más amplio y más rápido cuando el oído está listo.",
    ...
    fr: {
      ...
      heroLede: "EarPT est une app d’oreille quotidienne pour musiciens qui te rejoint là où tu es : débutant à pro, intervalles simples à harmonie avancée. Tu entends un intervalle, un accord ou une courte mélodie, puis tu le nommes. Le son est un piano à queue samplé ou une guitare acoustique.",
      heroArtCredit: "Image générée par IA.",
      phoneArtCredit: "Image générée par IA. L’app sur le banc.",
      heroBy: "Une oreille entraînée, c’est la liberté musicale.",
      ctaSupport: "Support et retours",
      ctaWhy: "Comment ça marche",
      ...
      card3p: "Un piano à queue et une guitare acoustique microphonée. Une couleur organique, pour que l’oreille s’entraîne sur le bois et la corde — pas une onde carrée.",
      soundKicker: "Le son",
      soundTitle: "Des notes organiques. De vrais instruments.",
      soundLede: "L’oreille n’est aussi bonne que ce que tu entends. EarPT joue un piano à queue samplé et une guitare acoustique enregistrée au micro — la couleur du bois et de la corde, pas un synthé jouet.",
      ...
      sound2p: "Une guitare acoustique microphonée. Change dans Réglages quand la salle doit sonner comme des cordes.",
      metaDescription: "App d’entraînement d’oreille pour iPhone et iPad. Piano et guitare samplés, pour que l’oreille s’entraîne sur ce que tu joues vraiment.",
      ...
      quote: "Fait par des musiciens pour des musiciens.",
      ...
      faq3a: "Un piano à queue samplé et une guitare acoustique microphonée. Couleur organique — bois et corde, pas un synthé jouet. Change dans Réglages.",
      faq4q: "C’est sur iPhone et iPad ?",
      faq4a: "Oui. iPhone et iPad. Télécharge-la dans l’App Store.",
      faq5q: "C’est un abonnement ?",
      faq5a: "Non. Dix séances sont libres. Puis un achat unique qui débloque le reste. Pas un abonnement.",
      workKicker: "Le travail",
      workTitle: "Entends-le. Nomme-le.",
      workLede: "Commence simple. Plus dur quand l’oreille est prête. Entendre les notes, entendre les accords. L’étage et la carte se souviennent de ce que tu as fini.",
      work1t: "Entendre les notes",
      work1p: "Des intervalles dans la tonalité. La distance reçoit un nom. Vite quand tu es propre.",
      work2t: "Entendre les accords",
      work2p: "Qualité et couleur. Majeur, mineur, septièmes. Nomme la couleur, puis prends-la sur l’instrument.",
      work3t: "Entendre les mélodies",
      work3p: "Une phrase sur la portée. Ce que tu entends dedans est une ligne que tu peux jouer.",
      workSimple: "Commence simple",
      workReady: "Plus dur quand l’oreille est prête",
      workStafft: "Place la phrase",
      workStaffp: "Entends une ligne. Pose-la sur la portée. C’est la mélodie, pas un quiz.",
      workProgt: "Ton étage",
      workProgp: "Séances que tu as finies. Touches en or. Le graphe, c’est de revenir.",
      workMapt: "La carte",
      workMapp: "Étages et salles. Vert, c’est fini. Or, c’est ici.",
      faq6q: "Comment s’entraîne-t-on à entendre les accords ?",
      faq6a: "Écoute un voicing, nomme la qualité, reviens demain. EarPT te garde dans la salle jusqu’à ce que ce soit propre — majeur, mineur, septièmes, puis plus de couleur.",
      faq7q: "Comment s’entraîne-t-on à entendre les mélodies ?",
      faq7a: "Une courte phrase. Tu l’entends, puis tu la places. Cinq minutes, la plupart des jours. La ligne tient parce que tu reviens.",
      faq8q: "Comment s’entraîne-t-on à entendre les notes et les intervalles ?",
      faq8a: "Deux notes, dans la tonalité. Tu nommes la distance. Simple quand c’est le travail. Plus large et plus vite quand l’oreille est prête.",
